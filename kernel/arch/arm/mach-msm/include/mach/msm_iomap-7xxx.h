...
#define MSM_HTC_RAM_CONSOLE_PHYS	0x1FD00000  /* must be the same as MSM_RAM_CONSOLE_BASE in board file */
#else
#define MSM_HTC_RAM_CONSOLE_PHYS        0x2FD00000  /* must be the same as      MSM_RAM_CONSOLE_BASE in board file */
#endif
#define MSM_HTC_RAM_CONSOLE_SIZE	(SZ_1M - SZ_128K)  /* 128K for debug info */
#endif

#ifdef CONFIG_MSM_HTC_DEBUG_INFO
#define MSM_HTC_DEBUG_INFO_BASE 	IOMEM(0xFB000000)
