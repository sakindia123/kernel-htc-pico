...
struct msm_htc_debug_info *htc_debug_info;

void __init htc_debug_info_init(void)
{
	htc_debug_info = MSM_HTC_DEBUG_INFO_BASE;
	memset(htc_debug_info, 0, MSM_HTC_DEBUG_INFO_SIZE);
}
#endif
