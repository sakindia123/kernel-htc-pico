...
tools/mkbootfs boot | lzma > unpack/boot.img-ramdisk-new.lzma
mkdir -p target_img
tools/mkbootimg --kernel unpack/boot.img-zImage --ramdisk unpack/boot.img-ramdisk-new.lzma -o target_img/boot.img --base `cat unpack/boot.img-base`	
...
zip cranium-kernel.zip boot.img META-INF/com/google/android/updater-script META-INF/com/google/android/update-binary system/lib/modules/bcm4330.ko  system/lib/modules/kineto_gan.ko system/etc/init.d/93zram system/bin/compcache system/bin/handle_compcache system/bin/zram_stats
